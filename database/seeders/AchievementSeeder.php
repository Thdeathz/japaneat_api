...
class AchievementSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('achievements')->insert([
            [
                'name' => 'Lofi music 1',
                'image' => 'https://firebasestorage.googleapis.com/v0/b/japaneat-525ab.appspot.com/o/images%2F83446803_p0_master1200.png?alt=media&token=4fc03332-cf9b-4685-a868-f1616665da15',
